 ...
 *   badge      {string}  - Optional badge label (e.g. "New", "Price Drop")
 *   name       {string}  - Property name / title (used in featured layout)
 *   price      {string}  - Formatted price string, e.g. "$2,450,000"
 *   location   {string}  - Address or neighborhood
 *   beds       {string|number}
 *   baths      {string|number}
 *   sqft       {string}  - e.g. "2,100 sqft"
 *   variant    {"featured"|"listing"}  - Card style variant
 *   onFavorite {Function} - Optional favorite toggle callback (listing variant)
 */
