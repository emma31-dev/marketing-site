const TEAM = [
    {
        ...
        bio: "Adaeze founded PadEstate in 2011 after a decade managing high-value property portfolios across Lagos and Abuja. Her vision was simple: to build Nigeria's most trusted premium real estate firm — one that combined the rigour of global best practice with a deep understanding of the local market. Today she leads a team of over 40 specialists and has personally overseen transactions exceeding ₦200 billion. A fellow of the Nigerian Institution of Estate Surveyors and Valuers (NIESV), Adaeze is a respected voice on housing policy and urban development.",
    },
    {
        id: 2,
        name: "Emeka Eze",
    ...
    },
    {
        ...
        bio: "Tunde is the analytical engine behind PadEstate's market intelligence. He produces the bi-annual PadEstate Property Index — the most cited independent residential market report in Nigeria — drawing on transaction data, macroeconomic indicators, and on-the-ground intelligence across six states. His research has been referenced by the CBN, Stanbic IBTC, and the Federal Ministry of Housing. Clients rely on Tunde's forecasts to time acquisitions and disposals for maximum return.",
    },
];
        ...
        <main className="bg-surface text-on-surface">
            ...
            <section className="max-w-container-max mx-auto px-gutter pt-section-padding-mobile md:pt-section-padding-desktop pb-16 text-center">
                ...
                <p className="text-lg text-secondary max-w-2xl mx-auto leading-relaxed">
                    PadEstate was founded on one belief: that every Nigerian deserves to find a home that reflects their ambition. From Lekki to Maitama, from GRA Port Harcourt to Bodija, we bring world-class expertise to Africa's most dynamic property market.
                </p>
            </section>
            ...
            <section className="max-w-container-max mx-auto px-gutter py-section-padding-mobile md:py-section-padding-desktop">
                <div className="max-w-2xl mx-auto text-center">
                    <span className="material-symbols-outlined text-4xl text-primary mb-6 block">diamond</span>
            ...
            {/* Team section */}
            <section className="bg-surface-container-low border-t border-outline-variant py-section-padding-mobile md:py-section-padding-desktop">
                                ...
                                >
                                    ...
                                    <div className="w-full md:w-1/2 flex-shrink-0">
                                        <div className="aspect-[4/3] rounded-xl overflow-hidden">
                                            <img
                                                src={member.image}
                                                alt={`Portrait of ${member.name}, ${member.role} at PadEstate`}
